...
//     	map.EditPro_click();
		...
		/*
		 * Assert.assertTrue(map.editPro_FirstNMUNSuccessMsg()
		 * ,"First not Successfull edited");
		 * Assert.assertTrue(map.editPro_LastNMUNSuccessMsg()
		 * ,"Last not Successfull edited");
		 * Assert.assertTrue(map.editPro_EmailUNSuccessMsg()
		 * ,"Email not Successfull edited");
		 * Assert.assertTrue(map.editPro_MobileUNSuccessMsg()
		 * ,"Mobile not Successfull edited");
		 * Assert.assertTrue(map.editPro_adressUNSuccessMsg()
		 * ,"Adress not Successfull edited");
		 * Assert.assertTrue(map.editPro_CityUNSuccessMsg()
		 * ,"City not Successfull edited");
		 * Assert.assertTrue(map.editPro_CountryUNSuccessMsg()
		 * ,"Country not Successfull edited");
		 * Assert.assertTrue(map.editPro_PostalCodeUNSuccessMsg()
		 * ,"Postal code not Successfull edited");
		 */}
...
//     	map.EditPro_click();
		...
		// Assert.assertTrue(map.editPro_timezonSuccessMsg(),"Timezon not Successfull
		// edited");
	}
}
