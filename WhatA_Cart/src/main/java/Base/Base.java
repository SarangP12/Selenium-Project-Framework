...
public class Base {
	...
	public Base() {
		...
		prop.load(fiS);
		 ...
		 File dataproFile=new File(System.getProperty("user.dir")+"\\src\\main\\java\\com\\Config\\testData.properties");
...
//-----------------------------copy and paste here code for reducesetup method-------------------------------------------
	public WebDriver initializeBrowserAndOpenApplicationURL(String browserNameString) {
				...
				//browserNameString="chrome";------equalIgnore case beacause we can wright capital or small latter in config file
