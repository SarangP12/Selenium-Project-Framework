...
public class MyOrder extends Base {
	...
	//Verify that the click on my_order_Status when list will be Assending order open
	...
	//Verify that the click on my_order_Amount when list will be Assending order open
	...
	//Verify that the click on my_order_view_General tab and shows details on general page
	...
	@Test(priority = 7, groups = "Possitive_TC")
	//Verify that the click on my_order_view_BillingAdress tab and shows details on billing page
	...
	//Verify that the click on my_order_view_ShipingAdress tab and shows details on Shiping page
	...
	//Verify that the click on my_order_view_Payment tab and shows details on Payment page
	...
	//Verify that the click on my_order_view_Product tab and shows details on product page
	...
	//Verify that the click on my_order_view_Product_tab Again click on Product name and shows products related all details
