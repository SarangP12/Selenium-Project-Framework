...
public class product_Info extends Base {
	...
	@Test(priority =1)
	//verify to test that the product page should be open or not using the my account page
	...
	@Test(priority =1)
	//verify to test that the product page should be open or not using the home page
